...
function App() {
    ...
    useEffect(() => {
        fetchStatus();
        fetchLogs();
        const ws = new WebSocket('ws://54.198.221.238:3001');
        ws.onmessage = (event) => {
    ...
    const fetchStatus = async () => {
        try {
            const response = await axios.get('http://54.198.221.238:3001/status');
    ...
    const fetchLogs = async () => {
        try {
            const response = await axios.get('http://54.198.221.238:3001/logs');
    ...
    const toggleAlarm1 = async () => {
        ...
        try {
            await axios.post('http://54.198.221.238:3001/set_alarm', { alarm1: newState });
    ...
    const toggleAlarm2 = async () => {
        ...
        try {
            await axios.post('http://54.198.221.238:3001/set_alarm', { alarm2: newState });
    ...
    const toggleLaser = async () => {
        ...
        try {
            await axios.post('http://54.198.221.238:3001/set_alarm', { laser: newState });
    ...
    const toggleMovement = async () => {
        ...
        try {
            await axios.post('http://54.198.221.238:3001/set_alarm', { movement: newState });
